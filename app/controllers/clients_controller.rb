class ClientsController < ApplicationController
  ...
  private
    ...
    def client_params
      params.require(:client).permit(:user_id, :first_name, :last_name, :phone, :colour, :notes, addresses_attributes: [:client_id, :address1, :address2, :town_or_city, :county, :post_code])
    end
end
